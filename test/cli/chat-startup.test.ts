...
test("startup reports version, context, and the loaded keybindings", {
  ...
  await waitForOutput(session.read, "Rigyn v0.1.3 · Ready");
...
test("extension-only durable sessions survive Ctrl+D and resume by exact ID or latest", {
  ...
  await waitForOutput(first.read, "Rigyn v0.1.3 · Ready");
  ...
  await waitForOutput(second.read, "Rigyn v0.1.3 · Ready");
  ...
  await waitForOutput(third.read, "Rigyn v0.1.3 · Ready");
