...
import type { ModelInfo } from "rigyn/core";
import { createInteractiveDirectUiContext } from "rigyn/tui";
...
declare const rpcClient: import("rigyn").RpcClient;
...
void [session.sessionId, manager.getSessionId(), branchEntry, registry, command.type, imageCommand.type, response.type, event.type, rpcModels, rpcImagePrompt];
