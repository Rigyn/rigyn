...
function offlineNpmCache() {
  ...
  const captured = globalThis[Symbol.for("rigyn.test.npm-cache-path")];
...
function assertSafePackageFiles(files) {
  ...
  for (const required of [
    ...
    "resources/skills/rigyn-dev/SKILL.md",
    "resources/skills/rigyn-dev/references/configuration.md",
    "resources/skills/rigyn-dev/references/extensions.md",
    "resources/skills/rigyn-dev/references/core-tui-providers.md",
    "resources/skills/rigyn-dev/references/project-development.md",
    "resources/skills/rigyn-dev/references/testing-release.md",
...
test("production package builds omit source maps and source-map directives", async () => {
  for (const { directory } of RIGYN_PRODUCT_PACKAGE_GRAPH) {
...
test("packed artifact bootstraps into a blank home and completes a cached offline user install", {
  ...
  const packageExportCheck = await runCommand(process.execPath, [
    ...
    [
      `const internal = ${JSON.stringify([
        "@rigyn/models/api/internal/codex-websocket",
        "@rigyn/models/api/internal/http",
        "@rigyn/models/api/internal/message-stream",
        "@rigyn/models/api/internal/sdk-request",
        "@rigyn/models/providers/create-builtin",
      ])}`,
      ...
      `for (const specifier of ${JSON.stringify([
        "@rigyn/models/api/openai-responses",
        "@rigyn/models/api/openai-responses.lazy",
        "@rigyn/models/providers/images/register-builtins",
        "@rigyn/models/providers/openai",
  ...
  await Promise.all([
    ...
    access(join(packageRoot, "resources", "skills", "rigyn-dev", "SKILL.md")),
    access(join(packageRoot, "resources", "skills", "rigyn-dev", "references", "configuration.md")),
    access(join(packageRoot, "resources", "skills", "rigyn-dev", "references", "extensions.md")),
    access(join(packageRoot, "resources", "skills", "rigyn-dev", "references", "core-tui-providers.md")),
    access(join(packageRoot, "resources", "skills", "rigyn-dev", "references", "project-development.md")),
    access(join(packageRoot, "resources", "skills", "rigyn-dev", "references", "testing-release.md")),
  ]);
