...
test("release workspace permits workflow-downloaded native prebuilds only", async (context) => {
  ...
  const nativePrebuilds = [
    ...
    "packages/terminal/native/darwin/prebuilds/darwin-arm64/rigyn-keychain-helper",
    "packages/terminal/native/darwin/prebuilds/darwin-x64/darwin-modifiers.node",
    "packages/terminal/native/darwin/prebuilds/darwin-x64/rigyn-keychain-helper",
    ...
    "packages/kernel/native/win32/prebuilds/win32-arm64/rigyn-job-launcher.exe",
    "packages/kernel/native/win32/prebuilds/win32-x64/rigyn-job-launcher.exe",
  ];
...
test("source archive policy requires the build and private-install inputs", () => {
  for (const path of [
    ...
    "packages/rigyn/resources/config.example.json",
    "packages/rigyn/resources/schemas/config-v1.json",
    "packages/rigyn/resources/schemas/theme-v1.json",
    "packages/terminal/scripts/build-native.mjs",
    "packages/terminal/native/darwin/src/darwin-modifiers.c",
    "packages/terminal/native/darwin/src/rigyn-keychain-helper.swift",
    ...
    "packages/kernel/native/win32/src/rigyn-job-launcher.c",
    ...
    "packages/rigyn/tsconfig.test.json",
...
test("release source archives stay pinned when the selected ref moves", async (context) => {
  ...
  const output = resolve(fixture.root, "release", "rigyn-v1.2.3-source.tar.gz");
