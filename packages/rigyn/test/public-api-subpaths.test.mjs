...
import * as serve from "rigyn/serve";
...
test("extension contract internals cannot resolve as package subpaths", () => {
  for (const specifier of [
    "rigyn/extensions/capabilities/internal/api/lifecycle",
    "rigyn/extensions/capabilities/internal/events/tools",
    "rigyn/extensions/runtime-internal/generation-lifecycle",
  ]) {
    assert.throws(
