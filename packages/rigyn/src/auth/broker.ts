...
export const DEFAULT_ENVIRONMENT_CREDENTIALS: Readonly<Record<string, EnvironmentCredentialSpec>> = {
  ...
  "azure-openai-responses": { variable: "AZURE_OPENAI_API_KEY" },
  "azure-openai": { variable: "AZURE_OPENAI_API_KEY" },
  anthropic: { variable: "ANTHROPIC_OAUTH_TOKEN", aliases: ["ANTHROPIC_API_KEY"] },
  "github-copilot": { variable: "COPILOT_GITHUB_TOKEN" },
  google: { variable: "GEMINI_API_KEY" },
  gemini: { variable: "GEMINI_API_KEY" },
  "google-vertex": { variable: "GOOGLE_CLOUD_API_KEY" },
  "amazon-bedrock": { variable: "AWS_BEARER_TOKEN_BEDROCK", kind: "bearer" },
  ...
  radius: { variable: "RADIUS_API_KEY" },
  ...
  "qwen-token-plan": { variable: "QWEN_TOKEN_PLAN_API_KEY" },
  "qwen-token-plan-cn": { variable: "QWEN_TOKEN_PLAN_CN_API_KEY" },
};
