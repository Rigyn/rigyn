...
export function normalizeOAuthRegistrationConfig(value: unknown): OAuthRegistrationConfig {
  ...
  if (input.flow === "pkce") {
    ...
    if (input.requireRefreshToken !== undefined && typeof input.requireRefreshToken !== "boolean") {
    ...
    return {
      ...
      ...(input.requireRefreshToken === undefined ? {} : { requireRefreshToken: input.requireRefreshToken }),
