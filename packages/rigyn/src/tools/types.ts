...
import type { ImageBlock, NormalizedUsage, ToolDefinition } from "../core/types.js";
...
export interface HarnessTool {
  ...
  /** One sequential tool makes its complete provider-requested batch run in source order. */
