...
export const RELOAD_RESOURCE_SUMMARY = "keybindings, extensions, skills, prompts, themes, and context files";
...
export const INTERACTIVE_COMMANDS: readonly InteractiveCommandDefinition[] = [
  ...
  { name: "thinking", syntax: "thinking [LEVEL]", activePolicy: DEFER, hidden: false, help: true, palette: { id: "thinking", label: "Show or set reasoning level", detail: "/thinking [off|minimal|low|medium|high|xhigh|max]", value: "/thinking" } },
  ...
  { name: "resume", syntax: "resume [--all|SESSION]", activePolicy: DEFER, hidden: false, help: true, palette: { id: "resume", label: "Resume another session", detail: "/resume [--all|SESSION]", value: "/resume" } },
  { name: "reload", syntax: "reload", activePolicy: DEFER, hidden: false, help: true, palette: { id: "reload", label: `Reload ${RELOAD_RESOURCE_SUMMARY}`, detail: "/reload", value: "/reload" } },
  { name: "help", syntax: "help", activePolicy: DEFER, hidden: false, help: true, palette: { id: "help", label: "Show interactive commands", detail: "/help", value: "/help" } },
  ...
  { name: "clear", aliasFor: "new", syntax: "clear", activePolicy: DEFER, hidden: true, help: false },
