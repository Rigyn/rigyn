...
export const INTERACTIVE_COMMANDS: readonly InteractiveCommandDefinition[] = [
  ...
  { name: "scoped-models", syntax: "scoped-models", activePolicy: DISPATCH, hidden: false, help: true, palette: { id: "scoped-models", label: "Configure model cycling", detail: "/scoped-models", value: "/scoped-models" } },
  ...
  { name: "fork", syntax: "fork", activePolicy: INTERRUPT, hidden: false, help: true, palette: { id: "fork", label: "Fork from an earlier message", detail: "/fork", value: "/fork" } },
  { name: "clone", syntax: "clone [NAME]", activePolicy: INTERRUPT, hidden: false, help: true, palette: { id: "clone", label: "Clone current session", detail: "/clone", value: "/clone" } },
  { name: "tree", syntax: "tree", activePolicy: DISPATCH, hidden: false, help: true, palette: { id: "tree", label: "Navigate session tree", detail: "/tree", value: "/tree" } },
  ...
  { name: "models", aliasFor: "model", syntax: "models [PROVIDER/MODEL]", activePolicy: DISPATCH, hidden: true, help: false },
