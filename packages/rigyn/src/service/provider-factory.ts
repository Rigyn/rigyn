...
function createRoutedProviderAdapter(
  ...
  const internalOptions = options as typeof options & OpenAICodexObservabilityOptions;
  ...
  for (const [name, normalized] of normalizedDefinitions) {
    delegates.set(name, createProviderAdapter(normalized, broker, {
        ...
        ...(internalOptions[OPENAI_CODEX_TRANSPORT_OBSERVER] === undefined
          ? {}
          : { [OPENAI_CODEX_TRANSPORT_OBSERVER]: internalOptions[OPENAI_CODEX_TRANSPORT_OBSERVER] }),
      }));
  }
  ...
  switch (config.kind) {
    ...
    case "openai":
      return new OpenAIResponsesAdapter({
        ...
        ...(config.reasoningSummaries === undefined ? {} : { reasoningSummaries: config.reasoningSummaries }),
        ...(config.reasoningTextDisplay === undefined ? {} : { reasoningTextDisplay: config.reasoningTextDisplay }),
        ...transport,
      });
    case "azure-openai":
    ...
    case "anthropic":
      return new AnthropicAdapter({
        ...
        ...(config.maxTemperature === undefined ? {} : { maxTemperature: config.maxTemperature }),
