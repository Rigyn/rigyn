...
export interface RuntimeToolRenderer {
  renderCall?(view: Readonly<RuntimeToolRenderView>, context: RuntimeUiRenderContext): RuntimeUiBlock | undefined;
  renderResult?(view: Readonly<RuntimeToolRenderView>, context: RuntimeUiRenderContext): RuntimeUiBlock | undefined;
}

export interface RuntimeToolRendererBinding {
  has(name: string): boolean;
  renderCall(name: string, view: RuntimeToolRenderView, context: RuntimeUiRenderContext): RuntimeUiBlock | undefined;
